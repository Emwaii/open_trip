    ...
    <body>
        ...
        <main class="main">
            ...
            <section class="home" id="home">
                <img src= <?= base_url('img/home1.jpg')?> alt="" class="home__img">
                ...
                <div class="home__container container grid">
                    ...
                    <div class="home__info">
                        ...
                        <div class="home__info-overlay">
                            <img src=<?= base_url('img/home2.jpg')?> alt="" class="home__info-img">
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div class="about__container container grid">
                    ...
                    <div class="about__img">
                        <div class="about__img-overlay">
                            <img src= <?= base_url('img/about1.jpg')?> alt="" class="about__img-one">
                        </div>

                        <div class="about__img-overlay">
                            <img src=<?= base_url('img/about2.jpg')?> alt="" class="about__img-two">
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div class="discover__container container swiper-container">
                    <div class="swiper-wrapper">
                        ...
                        <div class="discover__card swiper-slide">
                            <img src=<?= base_url('img/discover1.jpg')?> alt="" class="discover__img">
                        ...
                        <!--==================== DISCOVER 2 ====================-->
                        <div class="discover__card swiper-slide">
                            <img src=<?= base_url('img/discover2.jpg')?> alt="" class="discover__img">
                            <div class="discover__data">
                        ...
                        <!--==================== DISCOVER 3 ====================-->
                        <div class="discover__card swiper-slide">
                            <img src=<?= base_url('img/discover3.jpg')?> alt="" class="discover__img">
                            <div class="discover__data">
                        ...
                        <!--==================== DISCOVER 4 ====================-->
                        <div class="discover__card swiper-slide">
                            <img src=<?= base_url('img/discover4.jpg')?> alt="" class="discover__img">
                            <div class="discover__data">
                ...
                <div class="experience__container container grid">
                    ...
                    <div class="experience__img grid">
                        <div class="experience__overlay">
                            <img src=<?= base_url('img/experience1.jpg')?> alt="" class="experience__img-one">
                        </div>
                        
                        <div class="experience__overlay">
                            <img src=<?= base_url('img/experience2.jpg')?> alt="" class="experience__img-two">
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section class="place section" id="place">
                ...
                <div class="place__container container grid">
                    ...
                    <div class="place__card">
                        <img src=<?= base_url('img/place1.jpg')?> alt="" class="place__img">
                    ...
                    <!--==================== PLACES CARD 2 ====================-->
                    <div class="place__card">
                        <img src=<?= base_url('img/place2.jpg')?>  alt="" class="place__img">
                    ...
                    <!--==================== PLACES CARD 3 ====================-->
                    <div class="place__card">
                        <img src=<?= base_url('img/place3.jpg')?>  alt="" class="place__img">
                    ...
                    <!--==================== PLACES CARD 4 ====================-->
                    <div class="place__card">
                        <img src=<?= base_url('img/place4.jpg')?>  alt="" class="place__img">
                    ...
                    <!--==================== PLACES CARD 5 ====================-->
                    <div class="place__card">
                        <img src=<?= base_url('img/place5.jpg')?>  alt="" class="place__img">
            ...
            <section class="sponsor section">
                <div class="sponsor__container container grid">
                    <div class="sponsor__content">
                        <img src=<?= base_url('img/sponsors1.png')?> alt="" class="sponsor__img">
                    </div>
                    <div class="sponsor__content">
                        <img src=<?= base_url('img/sponsors2.png')?> alt="" class="sponsor__img">
                    </div>
                    <div class="sponsor__content">
                        <img src=<?= base_url('img/sponsors3.png')?> alt="" class="sponsor__img">
                    </div>
                    <div class="sponsor__content">
                        <img src=<?= base_url('img/sponsors4.png')?> alt="" class="sponsor__img">
                    </div>
                    <div class="sponsor__content">
                        <img src=<?= base_url('img/sponsors5.png')?> alt="" class="sponsor__img">
                    </div>
                </div>
            </section>
        </main>
